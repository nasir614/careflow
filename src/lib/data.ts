...
export const initialClients: Client[] = [
  ...
  export const initialSchedules: Schedule[] = [
    { id: 401, clientId: 101, staffId: 202, servicePlanId: 801, serviceType: 'Adult Day Care', serviceCode: 'T2021', frequency: 'Weekly', totalUnits: 60, usedUnits: 24, hoursPerDay: 6.5, startDate: '2024-07-01', endDate: '2024-12-31', days: ['Monday', 'Wednesday', 'Friday'], timeInAM: '09:00', timeOutAM: '12:00', timeInPM: '13:00', timeOutPM: '15:30', status: 'active', createdAt: '2024-06-15' },
    { id: 402, clientId: 102, staffId: 203, servicePlanId: 802, serviceType: 'Personal Care', serviceCode: 'T1019', frequency: 'Daily', totalUnits: 120, usedUnits: 85, hoursPerDay: 4, startDate: '2024-05-01', endDate: '2024-10-31', days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], timeInAM: '09:00', timeOutAM: '13:00', status: 'active', createdAt: '2024-04-20' },
    { id: 403, clientId: 103, staffId: 202, servicePlanId: 803, serviceType: 'Day Support', serviceCode: 'S5150', frequency: 'Weekly', totalUnits: 40, usedUnits: 40, hoursPerDay: 5, startDate: '2023-06-01', endDate: '2024-05-31', days: ['Monday', 'Wednesday'], timeInAM: '10:00', timeOutAM: '15:00', status: 'expired', createdAt: '2023-05-15' },
    { id: 404, clientId: 101, staffId: 201, servicePlanId: 804, serviceType: 'Medical Check-up', serviceCode: 'T1002', frequency: 'Monthly', totalUnits: 12, usedUnits: 10, hoursPerDay: 1, startDate: '2024-01-01', endDate: '2024-12-31', days: ['Friday'], timeInAM: '11:00', timeOutAM: '12:00', status: 'active', createdAt: '2023-12-20' },
    { id: 405, clientId: 102, staffId: 204, servicePlanId: 805, serviceType: 'Respite Care', serviceCode: 'T1005', frequency: 'Bi-Weekly', totalUnits: 32, usedUnits: 16, hoursPerDay: 8, startDate: format(new Date(getYear(today), getMonth(today), 1), 'yyyy-MM-dd'), endDate: format(new Date(getYear(today), getMonth(today) + 1, 0), 'yyyy-MM-dd'), days: ['Saturday', 'Sunday'], timeInAM: '10:00', timeOutAM: '14:00', timeInPM: '15:00', timeOutPM: '19:00', status: 'pending', createdAt: format(subDays(today, 5), 'yyyy-MM-dd'), },
    { id: 406, clientId: 103, staffId: 203, servicePlanId: 803, serviceType: 'Day Support', serviceCode: 'S5150', frequency: 'Daily', totalUnits: 100, usedUnits: 25, hoursPerDay: 5, startDate: format(subDays(today, 30), 'yyyy-MM-dd'), endDate: format(addDays(today, 60), 'yyyy-MM-dd'), days: ['Tuesday', 'Thursday'], timeInAM: '10:00', timeOutAM: '12:30', timeInPM: '13:30', timeOutPM: '16:00', status: 'active', createdAt: format(subDays(today, 35), 'yyyy-MM-dd'), },
    { id: 407, clientId: 101, staffId: 202, servicePlanId: 801, serviceType: 'Adult Day Care', serviceCode: 'T2021', frequency: 'Weekly', totalUnits: 60, usedUnits: 10, hoursPerDay: 6.5, startDate: format(subDays(today, 30), 'yyyy-MM-dd'), endDate: format(addDays(today, 30), 'yyyy-MM-dd'), days: ['Tuesday', 'Thursday'], timeInAM: '09:00', timeOutAM: '12:00', timeInPM: '13:00', timeOutPM: '16:30', status: 'active', createdAt: format(subDays(today, 35), 'yyyy-MM-dd')},
    { id: 408, clientId: 102, staffId: 203, servicePlanId: 802, serviceType: 'Personal Care', serviceCode: 'T1019', frequency: 'Daily', totalUnits: 80, usedUnits: 40, hoursPerDay: 4, startDate: format(subDays(today, 15), 'yyyy-MM-dd'), endDate: format(addDays(today, 45), 'yyyy-MM-dd'), days: ['Monday', 'Friday'], timeInAM: '10:00', timeOutAM: '14:00', status: 'active', createdAt: format(subDays(today, 20), 'yyyy-MM-dd')},
    { id: 409, clientId: 103, staffId: 202, servicePlanId: 803, serviceType: 'Day Support', serviceCode: 'S5150', frequency: 'Weekly', totalUnits: 20, usedUnits: 20, hoursPerDay: 5, startDate: format(subDays(today, 60), 'yyyy-MM-dd'), endDate: format(subDays(today, 1), 'yyyy-MM-dd'), days: ['Wednesday'], timeInAM: '10:00', timeOutAM: '15:00', status: 'expired', createdAt: format(subDays(today, 65), 'yyyy-MM-dd')},
  ];

  export const initialAttendance: Attendance[] = [
    { id: 501, clientId: 101, staffId: 202, serviceType: 'Adult Day Care', date: format(today, 'yyyy-MM-dd'), checkInAM: '09:00', checkOutAM: '12:00', checkInPM: '13:00', checkOutPM: '15:30', totalHours: 5.5, location: 'Daycare Center', billingCode: 'T2021', status: 'present', notes: 'Regular day', createdAt: today.toISOString(), procedures: 'Standard daily activities', isBillable: true, adminStatus: 'Approved' },
    { id: 502, clientId: 102, staffId: 203, serviceType: 'Personal Care', date: format(today, 'yyyy-MM-dd'), checkInAM: '08:45', checkOutAM: '12:00', checkInPM: '12:30', checkOutPM: '15:15', totalHours: 6, location: 'Daycare Center', billingCode: 'T1019', status: 'present', notes: '', createdAt: today.toISOString(), procedures: 'Assisted with daily living tasks', isBillable: true, adminStatus: 'Pending' },
    { id: 503, clientId: 103, staffId: 202, serviceType: 'Day Support', date: format(yesterday, 'yyyy-MM-dd'), checkInAM: null, checkOutAM: null, checkInPM: null, checkOutPM: null, totalHours: 0, location: 'Daycare Center', billingCode: 'S5150', status: 'excused', notes: 'Medical appt in afternoon', createdAt: yesterday.toISOString(), procedures: '', isBillable: false, adminStatus: 'Approved' },
    { id: 504, clientId: 101, staffId: 202, serviceType: 'Adult Day Care', date: format(yesterday, 'yyyy-MM-dd'), checkInAM: '09:02', checkOutAM: '12:05', checkInPM: '13:00', checkOutPM: '15:33', totalHours: 5.5, location: 'Daycare Center', billingCode: 'T2021', status: 'present', notes: '', createdAt: yesterday.toISOString(), procedures: 'Group therapy session', isBillable: true, adminStatus: 'Approved' },
    { id: 505, clientId: 101, staffId: 202, serviceType: 'Adult Day Care', date: format(twoDaysAgo, 'yyyy-MM-dd'), checkInAM: null, checkOutAM: null, checkInPM: null, checkOutPM: null, totalHours: 0, location: 'Daycare Center', billingCode: 'T2021', status: 'absent', notes: 'No show', createdAt: twoDaysAgo.toISOString(), procedures: '', isBillable: false, adminStatus: 'Rejected' },
];
