  ...
  return (
    <aside className="w-64 bg-white/90 backdrop-blur-sm border-r border-gray-200 shadow-lg flex flex-col no-print">
      <div className="flex items-center p-6">
        <div className="h-8 w-8 bg-gradient-to-br from-primary to-pink-400 rounded-lg"></div>
        <h2 className="ml-3 text-xl font-bold bg-gradient-to-r from-accentPink to-accentOrange bg-clip-text text-transparent">
          CareFlow
        </h2>
      </div>
